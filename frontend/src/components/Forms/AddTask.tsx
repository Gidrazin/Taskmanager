              ...
              <Select defaultValue="">
                ...
                {performers.map((performerItem, index) => (
                  <Select.Option key={index} value={performerItem.username}>
                    {performerItem.first_name + " " + performerItem.last_name}
                  </Select.Option>
                ))}
              </Select>
            </Form.Item>
            <Form.Item label="Дата окончания" name="end">
              <DatePicker  />
            </Form.Item>
            <Form.Item label="Листок запуска" name="title">
              <Input />
            </Form.Item>

            <Form.Item name="pages" label="Количество листов">
              <InputNumber min={0} />
            </Form.Item>
          </div>
